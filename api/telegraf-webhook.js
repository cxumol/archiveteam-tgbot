  ...
  try {
    ...
    if (body.message) {
      ...
      if (myMatch) {
        ...
        await bot.sendMessage(id, "send <code>/get_${project}_${yourNickName}</code>\nFor example, /get_reddit_fuzzy80211", { parse_mode: "HTML" });
        await bot.sendMessage(id, "test2 /get_reddit_fuzzy80211 /get\\_reddit\\_fuzzy80211 get\\_reddit\\_fuzzy80211", { parse_mode: "MarkdownV2" });
      }
      }else{
